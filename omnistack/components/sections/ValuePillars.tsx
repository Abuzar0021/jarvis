      ...
      <div className="mt-12 grid gap-10 md:grid-cols-3 md:gap-8">
        {pillars.map((p, i) => (
          <Reveal key={p.title} delay={i * 0.08}>
            <div
              className="group relative flex h-full flex-col overflow-hidden rounded-2xl border border-hair bg-card p-7 transition-all duration-300 hover:-translate-y-1 hover:border-gold/40 hover:shadow-[0_24px_60px_-30px_rgba(47,224,238,0.14)]"
            >
              <Spotlight />
