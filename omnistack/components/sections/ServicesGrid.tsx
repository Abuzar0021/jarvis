        ...
        {services.map((s, i) => (
          <Reveal key={s.id} delay={(i % 3) * 0.06}>
            <Link
              ...
              className="group relative flex h-full flex-col rounded-2xl border border-hair bg-card p-7 transition-all duration-300 hover:-translate-y-1 hover:border-gold/40 hover:shadow-[0_24px_60px_-30px_rgba(212,175,55,0.4)]"
            >
